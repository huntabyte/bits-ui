...
You can use the "Open in Stackblitz" button in the bottom right corner of any demo component in the docs to quickly create a reproduction. You can also link to a GitHub repository with the reproduction.
