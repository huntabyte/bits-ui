...
export type CalendarUnitSnippetProps = {
	disabled: boolean;
	unavailable: boolean;
	selected: boolean;
	// day: string;
...
export type CalendarUnitPropsWithoutHTML = WithChild<{}, CalendarUnitSnippetProps>;

export type CalendarUnitProps = CalendarUnitPropsWithoutHTML &
	Without<BitsPrimitiveDivAttributes, CalendarUnitPropsWithoutHTML>;
