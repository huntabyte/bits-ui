...
export class RangeMonthCalendarRootState {
	...
	readonly opts: RangeMonthCalendarRootStateOpts;
...
export class RangeMonthCalendarCellState {
	...
	readonly opts: RangeMonthCalendarCellStateOpts;
	...
	constructor(opts: RangeMonthCalendarCellStateOpts, root: RangeMonthCalendarRootState) {
		this.opts = opts;
		this.root = root;
	}
...
interface RangeMonthCalendarDayStateOpts extends WithRefOpts {}

export class RangeMonthCalendarDayState {
	static create(opts: RangeMonthCalendarDayStateOpts) {
		return new RangeMonthCalendarDayState(opts, RangeMonthCalendarCellContext.get());
	}

	readonly opts: RangeMonthCalendarDayStateOpts;
	readonly cell: RangeMonthCalendarCellState;

	constructor(opts: RangeMonthCalendarDayStateOpts, cell: RangeMonthCalendarCellState) {
		this.opts = opts;
		this.cell = cell;
