...
const timeRangeFieldAttrs = createBitsAttrs({ component: "time-range-field", parts: ["root", "label"] });
const TimeRangeFieldRootContext = new Context("TimeRangeField.Root");
class TimeRangeFieldRootState {
  ...
  #startValueTime = /* @__PURE__ */ user_derived(() => {
  ...
  #endValueTime = /* @__PURE__ */ user_derived(() => {
...
class TimeRangeFieldInputState {
  static create(opts, type) {
    const root2 = TimeRangeFieldRootContext.get();
...
function TestTimeRangeFieldComponent() {
  const refs = [
    Time_range_field,
