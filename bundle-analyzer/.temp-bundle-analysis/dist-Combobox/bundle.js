...
function async_derived(fn, location) {
  ...
  async_effect(() => {
    ...
    var r2 = () => p;
    promise = prev2?.then(r2, r2) ?? Promise.resolve(p);
    prev2 = promise;
    var batch = (
      /** @type {Batch} */
      current_batch
...
function create_item(anchor, state2, prev2, next2, value, key2, index, render_fn, flags, get_collection, deferred2) {
...
function set_attributes(element, prev2, next2, css_hash, skip_warning = false) {
  var attributes = get_attributes(element);
  ...
  for (const key3 in next2) {
    ...
    if (key3 === "class") {
      ...
      set_class(element, is_html, value, css_hash, prev2?.[CLASS], next2[CLASS]);
      current[key3] = value;
      current[CLASS] = next2[CLASS];
      continue;
    }
    if (key3 === "style") {
      set_style(element, value, prev2?.[STYLE], next2[STYLE]);
      current[key3] = value;
...
function attribute_effect(element, fn, sync = [], async = [], css_hash, skip_warning = false) {
  flatten(sync, async, (values) => {
    ...
    block(() => {
      ...
      var current = set_attributes(element, prev2, next2, css_hash, skip_warning);
...
var root_1$3 = /* @__PURE__ */ from_html(`<input/>`);
...
class SelectItemState {
  ...
  #snippetProps = /* @__PURE__ */ user_derived(() => ({ selected: this.isSelected, highlighted: this.isHighlighted }));
  get snippetProps() {
    return get$2(this.#snippetProps);
  }
  set snippetProps(value) {
...
class SelectScrollDownButtonState {
  ...
  content;
  root;
  #canScrollDown = /* @__PURE__ */ state(false);
  get canScrollDown() {
    return get$2(this.#canScrollDown);
  }
...
class SelectScrollUpButtonState {
  ...
  content;
  root;
  #canScrollUp = /* @__PURE__ */ state(false);
  get canScrollUp() {
    return get$2(this.#canScrollUp);
  }
...
var root_3$2 = /* @__PURE__ */ from_html(`<input/>`);
function Combobox_input($$anchor, $$props) {
  push($$props, true);
  let id = prop($$props, "id", 19, useId), ref = prop($$props, "ref", 15, null), clearOnDeselect = prop($$props, "clearOnDeselect", 3, false), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
      ...
      children: ($$anchor3, $$slotProps) => {
        ...
        var node_1 = first_child(fragment_1);
        {
          ...
          var alternate = ($$anchor4) => {
            var input = root_3$2();
            attribute_effect(input, () => ({ ...get$2(mergedProps) }));
...
function Separator($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), decorative = prop($$props, "decorative", 3, false), orientation = prop($$props, "orientation", 3, "horizontal"), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
...
function Combobox_trigger($$anchor, $$props) {
  push($$props, true);
  let id = prop($$props, "id", 19, useId), ref = prop($$props, "ref", 15, null), type = prop($$props, "type", 3, "button"), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
    ...
    var consequent_1 = ($$anchor2) => {
      {
        const popper = ($$anchor3, $$arg0) => {
          ...
          let wrapperProps = () => $$arg0?.().wrapperProps;
          const finalProps = /* @__PURE__ */ user_derived(() => mergeProps(props(), { style: contentState.props.style }));
          var fragment_2 = comment();
...
function Select_content_static($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), forceMount = prop($$props, "forceMount", 3, false), onInteractOutside = prop($$props, "onInteractOutside", 3, noop), onEscapeKeydown = prop($$props, "onEscapeKeydown", 3, noop), preventScroll = prop($$props, "preventScroll", 3, false), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
...
function Select_item($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), label = prop($$props, "label", 19, () => $$props.value), disabled = prop($$props, "disabled", 3, false), onHighlight = prop($$props, "onHighlight", 3, noop), onUnhighlight = prop($$props, "onUnhighlight", 3, noop), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      var node_1 = first_child(fragment_1);
      {
        let $0 = /* @__PURE__ */ user_derived(() => ({ props: get$2(mergedProps), ...itemState.snippetProps }));
    ...
    var alternate = ($$anchor2) => {
      ...
      attribute_effect(div, () => ({ ...get$2(mergedProps) }));
      var node_2 = child(div);
      snippet(node_2, () => $$props.children ?? noop$1, () => itemState.snippetProps);
      append($$anchor2, div);
    };
    if_block(node, ($$render) => {
      if ($$props.child) $$render(consequent);
...
function Select_scroll_down_button($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), delay = prop($$props, "delay", 3, () => 50), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, scrollButtonState.props));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent_1 = ($$anchor2) => {
...
function TestComboboxComponent() {
  const refs = [
    Combobox,
    Combobox_input,
    Separator,
