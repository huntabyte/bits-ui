import { untrack as untrack$1, onMount } from "svelte";
...
function usePasswordManagerBadge({
  ...
  let hasPwmBadge = /* @__PURE__ */ state(false);
  let hasPwmBadgeSpace = /* @__PURE__ */ state(false);
...
class PinInputRootState {
  ...
  attachment;
  #inputRef = box(null);
  #isHoveringInput = /* @__PURE__ */ state(false);
  inputAttachment = attachRef(this.#inputRef);
  #isFocused = box(false);
  #mirrorSelectionStart = /* @__PURE__ */ state(null);
  #mirrorSelectionEnd = /* @__PURE__ */ state(null);
  #previousValue = new Previous(() => this.opts.value.current ?? "");
  #regexPattern = /* @__PURE__ */ user_derived(() => {
  ...
  #prevInputMetadata = /* @__PURE__ */ state(proxy({ prev: [null, null, "none"], willSyntheticBlur: false }));
  #pwmb;
  #initialLoad;
  domContext;
  constructor(opts) {
  ...
  onkeydown = (e) => {
    ...
    if (key && get(this.#regexPattern) && !get(this.#regexPattern).test(key)) {
      e.preventDefault();
    }
  };
  #rootStyles = /* @__PURE__ */ user_derived(() => ({
    position: "relative",
  ...
  #rootProps = /* @__PURE__ */ user_derived(() => ({
  ...
  #inputWrapperProps = /* @__PURE__ */ user_derived(() => ({
  ...
  #inputStyle = /* @__PURE__ */ user_derived(() => ({
    position: "absolute",
    inset: 0,
  ...
  #onDocumentSelectionChange = () => {
    ...
    const prev = get(this.#prevInputMetadata).prev;
    let start = -1;
    let end = -1;
    let direction;
  ...
  #inputProps = /* @__PURE__ */ user_derived(() => ({
  ...
  #cells = /* @__PURE__ */ user_derived(() => Array.from({ length: this.opts.maxLength.current }).map((_, idx) => {
    const isActive = this.#isFocused.current && get(this.#mirrorSelectionStart) !== null && get(this.#mirrorSelectionEnd) !== null && (get(this.#mirrorSelectionStart) === get(this.#mirrorSelectionEnd) && idx === get(this.#mirrorSelectionStart) || idx >= get(this.#mirrorSelectionStart) && idx < get(this.#mirrorSelectionEnd));
...
var root = /* @__PURE__ */ from_html(`<div><!> <div><input/></div></div>`);
function Pin_input($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), inputId = prop($$props, "inputId", 19, () => `${createId(uid)}-input`), ref = prop($$props, "ref", 15, null), maxlength = prop($$props, "maxlength", 3, 6), textalign = prop($$props, "textalign", 3, "left"), inputmode = prop($$props, "inputmode", 3, "numeric"), onComplete = prop($$props, "onComplete", 3, noop), pushPasswordManagerStrategy = prop($$props, "pushPasswordManagerStrategy", 3, "increase-width"), containerClass = prop($$props, "class", 3, ""), autocomplete = prop($$props, "autocomplete", 3, "one-time-code"), disabled = prop($$props, "disabled", 3, false), value = prop($$props, "value", 15, ""), onValueChange = prop($$props, "onValueChange", 3, noop), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
  ...
  const mergedInputProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, rootState.inputProps));
  const mergedRootProps = /* @__PURE__ */ user_derived(() => mergeProps(rootState.rootProps, { class: containerClass() }));
  const mergedInputWrapperProps = /* @__PURE__ */ user_derived(() => mergeProps(rootState.inputWrapperProps, {}));
  var div = root();
  attribute_effect(div, () => ({ ...get(mergedRootProps) }));
  var node = child(div);
  snippet(node, () => $$props.children ?? noop$1, () => rootState.snippetProps);
...
function TestPinInputComponent() {
  const refs = [
    Pin_input,
    Pin_input_cell
  ];
