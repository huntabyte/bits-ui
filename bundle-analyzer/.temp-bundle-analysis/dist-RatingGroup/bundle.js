import { untrack as untrack$1, hasContext, getContext, setContext } from "svelte";
...
const ratingGroupAttrs = createBitsAttrs({ component: "rating-group", parts: ["root", "item"] });
...
class RatingGroupRootState {
  ...
  opts;
  attachment;
  #hoverValue = /* @__PURE__ */ state(null);
  #keySequence = /* @__PURE__ */ state("");
  #keySequenceTimeout = null;
  domContext;
  #hasValue = /* @__PURE__ */ user_derived(() => this.opts.value.current > 0);
  get hasValue() {
  ...
  #valueToUse = /* @__PURE__ */ user_derived(() => get(this.#hoverValue) ?? this.opts.value.current);
  get valueToUse() {
  ...
  #ariaValuetext = /* @__PURE__ */ user_derived(() => {
  ...
  setHoverValue(value) {
    ...
    set(
      this.#hoverValue,
      value === null ? null : Math.max(this.opts.min.current, Math.min(this.opts.max.current, value)),
      true
    );
  }
  setValue(value) {
  ...
  handlers = {
    ...
    [ARROW_RIGHT]: () => {
      this.setHoverValue(null);
      const increment2 = this.opts.allowHalf.current ? 0.5 : 1;
      this.#adjustValue(this.isRTL ? -increment2 : increment2);
    },
    [ARROW_DOWN]: () => {
      this.setHoverValue(null);
      this.#adjustValue(this.opts.allowHalf.current ? -0.5 : -1);
  ...
  #handleDecimalInput(e) {
    ...
    if (e.key === "5" && get(this.#keySequence).match(/^\d+\.$/)) {
      e.preventDefault();
      set(this.#keySequence, get(this.#keySequence) + e.key);
...
class RatingGroupItemState {
  ...
  #isActive = /* @__PURE__ */ user_derived(() => this.root.isActive(this.opts.index.current));
  #isPartial = /* @__PURE__ */ user_derived(() => this.root.isPartial(this.opts.index.current));
  #state = /* @__PURE__ */ user_derived(() => {
...
function Rating_group($$anchor, $$props) {
  ...
  const ariaValuetext = /* @__PURE__ */ user_derived(() => {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, rootState.props, { "aria-label": $$props["aria-label"] }));
  var fragment = root();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
...
function Rating_group_item($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let disabled = prop($$props, "disabled", 3, false), ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "disabled",
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      var node_1 = first_child(fragment_1);
      {
        let $0 = /* @__PURE__ */ user_derived(() => ({ props: get(mergedProps), ...itemState.snippetProps }));
        snippet(node_1, () => $$props.child, () => get($0));
      }
      append($$anchor2, fragment_1);
    };
...
function TestRatingGroupComponent() {
  const refs = [
    Rating_group,
    Rating_group_item
  ];
