...
var root_2$3 = /* @__PURE__ */ from_html(`<input/>`);
...
const timeFieldAttrs = createBitsAttrs({ component: "time-field", parts: ["input", "label"] });
const TimeFieldRootContext = new Context("TimeField.Root");
const SEGMENT_CONFIGS = {
  hour: {
    min: (root2) => root2.hourCycle === 12 ? 1 : 0,
    max: (root2) => {
      if (root2.hourCycle === 24) return 23;
...
class TimeFieldRootState {
  ...
  #maxValueTime = /* @__PURE__ */ user_derived(() => {
  ...
  #minValueTime = /* @__PURE__ */ user_derived(() => {
  ...
  #valueTime = /* @__PURE__ */ user_derived(() => {
  ...
  #hourCycle = /* @__PURE__ */ user_derived(() => {
  ...
  #timeRef = /* @__PURE__ */ user_derived(() => this.value.current ?? this.placeholder.current);
  get timeRef() {
  ...
  #allSegmentContent = /* @__PURE__ */ user_derived(() => createTimeContent({
...
class TimeFieldHiddenInputState {
  ...
  #isoValue = /* @__PURE__ */ user_derived(() => this.root.value.current ? getISOTimeValue(this.root.value.current) : void 0);
  get isoValue() {
  ...
  #handleArrowUp(placeholder) {
    ...
    this.root.updateSegment(this.part, (prev) => {
      if (prev === null) {
        ...
        this.announcer.announce(String(next2));
...
class DateFieldSegmentState {
  static create(part, opts) {
    const root2 = TimeFieldRootContext.get();
    switch (part) {
      case "hour":
        return new TimeFieldHourSegmentState(opts, root2);
      case "minute":
        return new TimeFieldMinuteSegmentState(opts, root2);
      case "second":
        return new TimeFieldSecondSegmentState(opts, root2);
      case "dayPeriod":
        return new TimeFieldDayPeriodSegmentState(opts, root2);
      case "literal":
        return new TimeFieldLiteralSegmentState(opts, root2);
      case "timeZoneName":
        return new TimeFieldTimeZoneSegmentState(opts, root2);
      default:
...
function Time_field($$anchor, $$props) {
  push($$props, true);
  let disabled = prop($$props, "disabled", 3, false), hideTimeZone = prop($$props, "hideTimeZone", 3, false), onPlaceholderChange = prop($$props, "onPlaceholderChange", 3, noop), onValueChange = prop($$props, "onValueChange", 3, noop), validate = prop($$props, "validate", 3, noop), onInvalid = prop($$props, "onInvalid", 3, noop), placeholder = prop($$props, "placeholder", 15), value = prop($$props, "value", 15), readonly = prop($$props, "readonly", 3, false), readonlySegments = prop($$props, "readonlySegments", 19, () => []), required = prop($$props, "required", 3, false);
...
function TestTimeFieldComponent() {
  const refs = [
    Time_field,
    Time_field_input,
    Time_field_label,
