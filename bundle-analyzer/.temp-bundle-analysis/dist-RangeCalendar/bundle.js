...
var root_2$d = /* @__PURE__ */ from_html(`<table><!></table>`);
...
var root_2$c = /* @__PURE__ */ from_html(`<tbody><!></tbody>`);
...
var root_2$6 = /* @__PURE__ */ from_html(`<select><!></select>`);
...
var root_2$2 = /* @__PURE__ */ from_html(`<td><!></td>`);
...
function TestRangeCalendarComponent() {
  const refs = [
    Range_calendar,
    Range_calendar_day,
    Range_calendar_cell,
