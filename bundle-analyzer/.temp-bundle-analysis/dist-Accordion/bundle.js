...
class AccordionItemState {
  ...
  opts;
  root;
  #isActive = /* @__PURE__ */ user_derived(() => this.root.includesItem(this.opts.value.current));
  get isActive() {
...
class AccordionTriggerState {
  ...
  itemState;
  #root;
  #isDisabled = /* @__PURE__ */ user_derived(() => this.opts.disabled.current || this.itemState.opts.disabled.current || this.#root.opts.disabled.current);
  attachment;
...
class AccordionContentState {
  ...
  #dimensions = /* @__PURE__ */ state(proxy({ width: 0, height: 0 }));
  #open = /* @__PURE__ */ user_derived(() => this.opts.forceMount.current || this.item.isActive);
  get open() {
  ...
  #snippetProps = /* @__PURE__ */ user_derived(() => ({ open: this.item.isActive }));
  get snippetProps() {
...
function Accordion($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let disabled = prop($$props, "disabled", 3, false), value = prop($$props, "value", 15), ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), onValueChange = prop($$props, "onValueChange", 3, noop), loop = prop($$props, "loop", 3, true), orientation = prop($$props, "orientation", 3, "vertical"), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "disabled",
...
function Accordion_item($$anchor, $$props) {
  ...
  let id = prop($$props, "id", 3, defaultId), disabled = prop($$props, "disabled", 3, false), value = prop($$props, "value", 3, defaultId), ref = prop($$props, "ref", 15, null), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
...
function Accordion_header($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), level = prop($$props, "level", 3, 2), ref = prop($$props, "ref", 15, null), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
    ...
    const presence = ($$anchor2, $$arg0) => {
      ...
      var node = first_child(fragment_1);
      {
        var consequent = ($$anchor3) => {
          ...
          {
            let $0 = /* @__PURE__ */ user_derived(() => ({ props: get(mergedProps), ...contentState.snippetProps }));
