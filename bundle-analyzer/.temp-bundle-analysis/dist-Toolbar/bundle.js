...
const toolbarAttrs = createBitsAttrs({
  component: "toolbar",
...
class ToolbarGroupItemState {
  ...
  root;
  attachment;
  #isDisabled = /* @__PURE__ */ user_derived(() => this.opts.disabled.current || this.group.opts.disabled.current);
  ...
  #isPressed = /* @__PURE__ */ user_derived(() => this.group.includesItem(this.opts.value.current));
  get isPressed() {
  ...
  #ariaChecked = /* @__PURE__ */ user_derived(() => {
    return this.group.isMulti ? void 0 : getAriaChecked(this.isPressed);
  });
  #ariaPressed = /* @__PURE__ */ user_derived(() => {
...
function Toolbar($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), orientation = prop($$props, "orientation", 3, "horizontal"), loop = prop($$props, "loop", 3, true), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "ref",
...
function Toolbar_button($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let disabled = prop($$props, "disabled", 3, false), type = prop($$props, "type", 3, "button"), id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "child",
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, buttonState.props, { type: type() }));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
...
var root_2$2 = /* @__PURE__ */ from_html(`<a><!></a>`);
function Toolbar_link($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, linkState.props));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
...
function Toolbar_group($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), value = prop($$props, "value", 15), onValueChange = prop($$props, "onValueChange", 3, noop), disabled = prop($$props, "disabled", 3, false), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
...
function Toolbar_group_item($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, groupItemState.props, { type: type() }));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      var fragment_1 = comment();
      var node_1 = first_child(fragment_1);
      snippet(node_1, () => $$props.child, () => ({ props: get(mergedProps), pressed: groupItemState.isPressed }));
      append($$anchor2, fragment_1);
    };
    var alternate = ($$anchor2) => {
      var button = root_2();
      attribute_effect(button, () => ({ ...get(mergedProps) }));
      var node_2 = child(button);
      snippet(node_2, () => $$props.children ?? noop$1, () => ({ pressed: groupItemState.isPressed }));
      append($$anchor2, button);
    };
    if_block(node, ($$render) => {
      if ($$props.child) $$render(consequent);
