...
class DataTypeahead {
  ...
  handleTypeaheadSearch(key2) {
    ...
    const values = get$2(this.#candidateValues).map((item) => item ?? "");
...
function Select($$anchor, $$props) {
  ...
  const rootState = SelectRootState.create({
    ...
    inputValue: box.with(() => get$2(inputValue), (v) => set(inputValue, v, true)),
...
function Select_trigger($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), type = prop($$props, "type", 3, "button"), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
