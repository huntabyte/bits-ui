...
class CommandRootState {
  ...
  #commandState = /* @__PURE__ */ state(defaultState);
  get commandState() {
  ...
  #_commandState = /* @__PURE__ */ state(proxy(defaultState));
  get _commandState() {
  ...
  #getColumn(item, grid) {
    ...
    for (let r2 = 0; r2 < grid.length; r2++) {
      ...
      for (let c = 0; c < row.length; c++) {
        const column = row[c];
        if (column === void 0 || column.ref !== item) continue;
        return { columnIndex: c, rowIndex: r2 };
      }
    }
    return null;
  }
...
class CommandEmptyState {
  ...
  root;
  attachment;
  #shouldRender = /* @__PURE__ */ user_derived(() => {
...
class CommandGroupContainerState {
  ...
  #headingNode = /* @__PURE__ */ state(null);
  get headingNode() {
...
class CommandInputState {
  ...
  root;
  attachment;
  #selectedItemId = /* @__PURE__ */ user_derived(() => {
...
class CommandItemState {
  ...
  attachment;
  #group = null;
  #trueForceMount = /* @__PURE__ */ user_derived(() => {
  ...
  #isSelected = /* @__PURE__ */ user_derived(() => this.root.opts.value.current === this.trueValue && this.trueValue !== "");
  get isSelected() {
...
class CommandSeparatorState {
  ...
  root;
  attachment;
  #shouldRender = /* @__PURE__ */ user_derived(() => !this.root._commandState.search || this.opts.forceMount.current);
  get shouldRender() {
    return get(this.#shouldRender);
  }
  set shouldRender(value) {
...
var root$1 = /* @__PURE__ */ from_html(`<label><!></label>`);
function _command_label($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), restProps = /* @__PURE__ */ rest_props($$props, ["$$slots", "$$events", "$$legacy", "id", "ref", "children"]);
...
function Command_empty($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(emptyState.props, restProps));
...
function Command_group($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), value = prop($$props, "value", 3, ""), forceMount = prop($$props, "forceMount", 3, false), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
...
var root = /* @__PURE__ */ from_html(`<div style="display: contents;"><!></div>`);
function Command_group_items($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, groupItemsState.props));
  var div = root();
  var node = child(div);
  {
    var consequent = ($$anchor2) => {
...
var root_2$2 = /* @__PURE__ */ from_html(`<input/>`);
function Command_input($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let value = prop($$props, "value", 15, ""), autofocus2 = prop($$props, "autofocus", 3, false), id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "value",
  ...
  const inputState = CommandInputState.create({
    ...
    autofocus: box.with(() => autofocus2() ?? false)
  });
...
var root_1$1 = /* @__PURE__ */ from_html(`<div style="display: contents;" data-item-wrapper=""><!></div>`);
function Command_item($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), value = prop($$props, "value", 3, ""), disabled = prop($$props, "disabled", 3, false), onSelect = prop($$props, "onSelect", 3, noop), forceMount = prop($$props, "forceMount", 3, false), keywords = prop($$props, "keywords", 19, () => []), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "id",
...
var root_4 = /* @__PURE__ */ from_html(`<a><!></a>`);
var root_1 = /* @__PURE__ */ from_html(`<div style="display: contents;"><!></div>`);
...
function Command_viewport($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, listViewportState.props));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
...
function Command_loading($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let progress = prop($$props, "progress", 3, 0), id = prop($$props, "id", 19, () => createId(uid)), ref = prop($$props, "ref", 15, null), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "progress",
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, loadingState.props));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
