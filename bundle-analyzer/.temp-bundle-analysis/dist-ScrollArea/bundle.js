...
class IsMounted {
  ...
  constructor() {
    user_effect(() => {
      untrack$1(() => set(this.#isMounted, true));
      return () => {
...
class ScrollAreaScrollbarSharedState {
  ...
  constructor(scrollbarState) {
    ...
    user_pre_effect(() => {
      ...
      untrack$1(() => this.handleThumbPositionChange());
    });
...
class ScrollAreaThumbImplState {
  ...
  constructor(opts, scrollbarState) {
    ...
    user_effect(() => {
      ...
      untrack$1(() => this.scrollbarState.handleThumbPositionChange());
      const unsubListener = addEventListener(viewportNode, "scroll", handleScroll);
      return unsubListener;
    });
...
class ScrollAreaCornerImplState {
  ...
  #hasSize = /* @__PURE__ */ user_derived(() => Boolean(get(this.#width) && get(this.#height)));
  get hasSize() {
...
function Scroll_area_corner_impl($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, cornerState.props));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
...
function Scroll_area_corner($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), restProps = /* @__PURE__ */ rest_props($$props, ["$$slots", "$$events", "$$legacy", "ref", "id"]);
  const scrollAreaState = ScrollAreaRootContext.get();
  const hasBothScrollbarsVisible = /* @__PURE__ */ user_derived(() => Boolean(scrollAreaState.scrollbarXNode && scrollAreaState.scrollbarYNode));
  const hasCorner = /* @__PURE__ */ user_derived(() => scrollAreaState.opts.type.current !== "scroll" && get(hasBothScrollbarsVisible));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
...
function TestScrollAreaComponent() {
  const refs = [
    Scroll_area,
