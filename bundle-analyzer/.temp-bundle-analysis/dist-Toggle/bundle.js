import { untrack as untrack$1 } from "svelte";
...
function Toggle($$anchor, $$props) {
  const uid = props_id();
  push($$props, true);
  let ref = prop($$props, "ref", 15, null), id = prop($$props, "id", 19, () => createId(uid)), pressed = prop($$props, "pressed", 15, false), onPressedChange = prop($$props, "onPressedChange", 3, noop), disabled = prop($$props, "disabled", 3, false), type = prop($$props, "type", 3, "button"), restProps = /* @__PURE__ */ rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "ref",
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, toggleState.props, { type: type() }));
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      {
        let $0 = /* @__PURE__ */ user_derived(() => ({ props: get(mergedProps), ...toggleState.snippetProps }));
    ...
    var alternate = ($$anchor2) => {
      ...
      snippet(node_2, () => $$props.children ?? noop$1, () => toggleState.snippetProps);
