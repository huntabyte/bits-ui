...
class SliderSingleRootState extends SliderBaseRootState {
  ...
  handlePointerUp = () => {
    ...
    if (this.isActive) {
      this.opts.onValueCommit.current(untrack$1(() => this.opts.value.current));
    }
    this.isActive = false;
  };
...
class SliderMultiRootState extends SliderBaseRootState {
  ...
  #thumbsPropsArr = /* @__PURE__ */ user_derived(() => {
    ...
    return Array.from({ length: currValue.length || 1 }, (_, i) => {
      const currThumb = untrack$1(() => this.currentThumbIdx);
...
function Slider_tick($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, tickState.props));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
...
function Slider_tick_label($$anchor, $$props) {
  ...
  const mergedProps = /* @__PURE__ */ user_derived(() => mergeProps(restProps, tickLabelState.props));
  var fragment = comment();
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
