...
function setup<T extends TimeValue = Time>(props: TimeRangeFieldTestProps<T> = {}) {
	...
	const start = {
		...
		getHour: () => returned.queryByTestId("start-hour") as HTMLElement,
		getMinute: () => returned.queryByTestId("start-minute") as HTMLElement,
		getSecond: () => returned.queryByTestId("start-second") as HTMLElement,
		getDayPeriod: () => returned.queryByTestId("start-dayPeriod") as HTMLElement,
		getTimeZoneName: () => returned.queryByTestId("start-timeZoneName") as HTMLElement,
		getHiddenInput: () =>
	...
	const end = {
		...
		getHour: () => returned.queryByTestId("end-hour") as HTMLElement,
		getMinute: () => returned.queryByTestId("end-minute") as HTMLElement,
		getSecond: () => returned.queryByTestId("end-second") as HTMLElement,
		getDayPeriod: () => returned.queryByTestId("end-dayPeriod") as HTMLElement,
		getTimeZoneName: () => returned.queryByTestId("end-timeZoneName") as HTMLElement,
		getHiddenInput: () =>
