<script lang="ts">
	import { Listbox, type ListboxSingleRootProps, type WithoutChildrenOrChild } from "bits-ui";
	...
	type Props = Omit<ListboxSingleRootProps, "type"> & {
...
<Listbox.Root {...restProps} type="single" bind:value>
	<Listbox.Trigger
