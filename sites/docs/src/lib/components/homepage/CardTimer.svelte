<script lang=ts>
  ...
  <div class="bg-white shadow-card border border-border-input rounded-card-lg py-3 px-[14px] m-[10px] w-full">
    <div class="timer bg-foreground p-1 rounded-15px mb-5">
      ...
      <div class="labels flex gap-[3px] font-medium mt-[9px] mb-2 px-1">
        <div class="group label active px-2">design
          <X class="size-1.5 group-[.active]:block hidden relative top-[1px] ml-1.5" weight="bold" aria-label="Close" />
        </div>
