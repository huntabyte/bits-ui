...
type SharedPropOpts = Pick<PropSchema, "description" | "required" | "bindable">;
...
type DefineComponentPropOpts = Omit<PropSchemaComponent, "type"> & {
	type: string;
	definition: Component;
	stringDefinition: string;
};

export function defineComponentPropSchema(opts: DefineComponentPropOpts) {
...
type DefineStringPropSchemaOpts = Omit<PropSchemaString, "type" | "default"> & {
	type: string;
	default?: string | number | boolean;
};

export function defineStringPropSchema(opts: DefineStringPropSchemaOpts) {
	return definePropSchema({
		...opts,
...
export function defineUnionProp(opts: DefineUnionPropOpts): PropSchema {
...
export function defineBooleanProp(opts: DefineBooleanPropOpts) {
...
export function defineStringProp(opts: DefineStringPropOpts) {
	return defineStringPropSchema({
		type: "string",
		...opts,
		default: opts.default,
...
export function defineNumberProp(opts: DefineNumberPropOpts) {
	return defineStringPropSchema({
		type: "number",
		...opts,
		default: opts.default,
