...
>
	<Toolbar.Group bind:value={wave} type="single" class="inline-flex items-center gap-x-0.5">
		<Toolbar.GroupItem
			...
			value="sine"
			class="cursor-pointer bg-background-alt text-foreground/60 hover:bg-muted data-[state=on]:bg-foreground data-[state=on]:text-background active:data-[state=on]:bg-dark-10 inline-flex size-6 items-center justify-center rounded-[7px] transition-all active:scale-[0.98] lg:size-8  dark:bg-white dark:text-[#808080] dark:data-[state=on]:bg-[#18181B] dark:data-[state=on]:text-white"
		>
