	...
	>
		<Tabs.Root value="follow">
			...
			>
				<Tabs.Trigger
					value="follow"
					class="cursor-pointer text-xxs text-foreground/70 data-[state=active]:text-foreground data-[state=active]:shadow-mini h-[23px] w-full rounded-[7px] font-medium data-[state=active]:bg-white lg:h-8 lg:text-sm dark:text-[#171717]/70 dark:data-[state=active]:text-[#171717] dark:data-[state=active]:shadow-[0px_1px_0px_1px_rgba(0,_0,_0,_0.04);]"
					>Follow</Tabs.Trigger
				>
				<Tabs.Trigger
					value="other"
