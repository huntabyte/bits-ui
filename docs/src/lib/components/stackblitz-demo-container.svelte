...
<div class={theme}>
	<div class="bg-background min-h-screen">
		...
		<main class="flex h-full items-center justify-center p-4">
			...
			>
				<div
					class="bg-foreground text-background absolute left-0 top-0 select-none rounded-br-md rounded-tl-md px-2 py-1 font-mono text-xs font-medium tracking-tighter"
				>
					{name}
				</div>
				{@render children?.()}
