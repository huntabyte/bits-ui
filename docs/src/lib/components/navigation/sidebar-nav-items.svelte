		...
		{#each items as item, index (index)}
			{#if item.href}
				<a
					href={item.href}
					class={cn(
						"text-foreground focus-visible:ring-foreground focus-visible:ring-offset-background group inline-flex w-full items-center rounded-md px-2.5 py-1.5 transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2",
