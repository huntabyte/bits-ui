...
>
	<Command.Input
		class="focus-override h-input bg-background placeholder:text-foreground-alt/50 inline-flex w-[296px] truncate rounded-xl px-4 text-sm transition-colors focus:outline-hidden focus:ring-0"
