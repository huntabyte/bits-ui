...
<ContextMenu.Root>
	...
	<ContextMenu.Portal>
		<ContextMenu.Content
			class="focus-override border-muted bg-background shadow-popover w-[229px] rounded-xl border px-1 py-1.5 outline-hidden focus-visible:outline-hidden"
			forceMount
		>
				...
				{#if open}
					<div {...wrapperProps}>
						<div {...props} transition:fly={{ duration: 300 }}>
							<ContextMenu.Item
								class="rounded-button data-highlighted:bg-muted flex h-10 select-none items-center py-3 pl-3 pr-1.5 text-sm font-medium outline-hidden ring-0! ring-transparent!"
							>
							...
							<ContextMenu.Sub>
								<ContextMenu.SubTrigger
									class="rounded-button data-highlighted:bg-muted data-[state=open]:bg-muted flex h-10 select-none items-center py-3 pl-3 pr-1.5 text-sm font-medium outline-hidden ring-0! ring-transparent!"
								>
									<div class="flex items-center">
								...
								>
									<ContextMenu.Item
										class="rounded-button data-highlighted:bg-muted flex h-10 select-none items-center py-3 pl-3 pr-1.5 text-sm font-normal outline-hidden ring-0! ring-transparent!"
									>
										Header
									</ContextMenu.Item>
									<ContextMenu.Item
