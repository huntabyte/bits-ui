...
<Popover.Root bind:open>
	...
	border-border-input bg-background px-[21px] text-[15px] font-medium text-foreground shadow-mini transition-all hover:cursor-pointer hover:bg-muted active:scale-98"
	>
		Resize
	</Popover.Trigger>
	<Popover.Content
		...
		<div class="flex items-center pb-2">
			<div class="mr-2 flex items-center">
				<div class="relative mr-2">
					...
					<input
						type="number"
						class="h-input w-[119px] rounded-10px border border-border-input pl-10 pr-2 text-sm text-foreground"
						bind:value={width}
					/>
				</div>
				<div class="relative">
