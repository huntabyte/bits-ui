...
<div class="flex items-center space-x-3">
	...
	>
		<Switch.Thumb
			class="pointer-events-none block size-[30px] shrink-0 rounded-full bg-background data-[state=unchecked]:dark:bg-background transition-transform data-[state=checked]:translate-x-6 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:shadow-mini dark:border-background dark:shadow-mini dark:data-[state=unchecked]:border"
		/>
	</Switch.Root>
